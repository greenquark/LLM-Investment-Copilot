...
Usage:
    python scripts/test_quote_cache/inspect_cache.py
    python scripts/test_quote_cache/inspect_cache.py --symbol SOXL --timeframe 1D
    python scripts/test_quote_cache/inspect_cache.py --cache-dir data_cache/bars
"""
